...
- For `brand`, `garment_type`, `theme`, `region`, `year`, and `key_attributes`, return a list of strings/integers if multiple are found.
...
---
**EXAMPLE 2 (Multi-Value Request)**
USER TEXT: "I'm looking for Dior and Chanel jackets and coats for fall 2025 and spring 2026 in Europe and North America."
JSON OUTPUT:
{{
  "brand": ["Dior", "Chanel"],
  "garment_type": ["jacket", "coat"],
  "season": ["Fall", "Spring"],
  "year": [2025, 2026],
