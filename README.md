...
*   **Mermaid diagrams**: Use `\n` for multi-line node labels. If the diagram still doesn’t render in your environment, try using an online editor or a VS Code extension with Mermaid support.
